...
class SheetManipulator:
    ...
    def get_sheets_list(self, spreadsheet_name):
        spreadsheet = self.sheet_manager.sheet.client.open(spreadsheet_name)
    ...
    def change_data_range_format(self, spreadsheet_name, sheet_name, data_range, critical_points):
        worksheet = self.sheet_manager.sheet.client.open(spreadsheet_name).worksheet(sheet_name)
